...
const IconButton = ({
  ...
  const baseClasses =
    'inline-flex items-center justify-center rounded-full min-h-touch min-w-touch focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors';
  ...
  const variantClasses = {
    ...
    secondary:
      'bg-transparent border border-white text-white hover:bg-white hover:bg-opacity-15 focus:ring-white',
