  ...
  useEffect(() => {
    const fetchVenueDetails = async () => {
      try {
        ...
        const dates = concertData.map(concert => 
          new Date(concert.start_time).toISOString().split('T')[0]
        );
  ...
  return (
    ...
    >
      ...
      {venue.location_details && (
        <div className="mb-lg">
          <Typography variant="h4" className="mb-xs">Location</Typography>
      ...
      {venue.park && (
        <div className="mb-lg">
          <Typography variant="h4" className="mb-sm">Theme Park</Typography>
      ...
      <div className="mb-lg">
        <Typography variant="h3" className="mb-md">Performances Calendar</Typography>
        <Calendar
      ...
      <div className="mb-lg">
        <Typography variant="h3" className="mb-md">
          Performances on {selectedDate.toLocaleDateString('en-US', {
            weekday: 'long',
            month: 'long',
            day: 'numeric'
          })}
