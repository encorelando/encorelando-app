...
const BrandExamplePage = () => {
  return (
    <div className="bg-background min-h-screen text-white pb-nav">
      {/* Header */}
      <MainHeader />
      ...
      <main className="p-md space-y-lg">
        ...
        <section className="mb-xl">
          ...
          <p className="font-manrope mb-lg">
            This page demonstrates the updated EncoreLando branding, including colors, typography, and component styles.
          </p>
        ...
        <section className="mb-xl">
          ...
          <div className="space-y-md">
            ...
            <div>
              ...
              <BrandHeading level={1} className="mb-xs">Heading 1</BrandHeading>
              <BrandHeading level={2} className="mb-xs">Heading 2</BrandHeading>
              <BrandHeading level={3} className="mb-xs">Heading 3</BrandHeading>
              <BrandHeading level={4} className="mb-xs">Heading 4</BrandHeading>
            </div>
            ...
            <div>
              ...
              <BrandHeading level={2} gradient>Gradient Heading</BrandHeading>
            </div>
          </div>
        </section>
        ...
        <section className="mb-xl">
          ...
          <div className="space-y-md">
            <BrandCard>
              <BrandHeading level={3} className="mb-sm">Standard Card</BrandHeading>
              <p className="font-manrope">This is a standard card with white text on a semi-transparent background.</p>
            </BrandCard>
            
            <BrandCard featured>
              <BrandHeading level={3} gradient className="mb-sm">Featured Card</BrandHeading>
              <p className="font-manrope">This featured card has a gradient border to make it stand out.</p>
            </BrandCard>
            
            <BrandCard variant="interactive" onClick={() => alert('Card clicked')}>
              <BrandHeading level={3} className="mb-sm">Interactive Card</BrandHeading>
