...
/**
 * Legal pages for Encorelando (updated email & mailing address).
 */
  ...
  <PageLayout>
    <div className="px-md py-lg space-y-md">
      ...
      <Typography variant="body1">
        Encorelando (“<strong>we</strong>”, “<strong>us</strong>”, “<strong>our</strong>”) provides
        a live-events discovery platform focused on theme-park performances in Florida. This Policy
      ...
      <ul className="list-disc list-inside space-y-xxs">
        <li>Provide, operate, and maintain Encorelando.</li>
        <li>
      ...
      <Typography variant="body1">
        ...
        us run Encorelando — for example, Supabase for authentication and Netlify for hosting —
      ...
      <Typography variant="body1">
        ...
        <br />
        Mailing address: 123 Main St. Orlando FL 33896, USA
      </Typography>
    </div>
  </PageLayout>
);
...
export const TermsAndConditions = () => (
  <PageLayout>
    <div className="px-md py-lg space-y-md">
      ...
      <Typography variant="body1">
        By accessing or using Encorelando you agree to be bound by these Terms. If you do not agree
      ...
      <Typography variant="body1">
        Encorelando aggregates publicly available event schedules and displays them in a searchable
        interface. We do not sell tickets and cannot guarantee the accuracy of third-party
        schedules.
      </Typography>
      ...
      <Typography variant="body1">
        All original software, design, and data compilations are © {CURRENT_YEAR} Encorelando.
        Third-party images remain property of their respective owners.
      </Typography>
      ...
      <Typography variant="body1">
        Encorelando is currently free. We may introduce premium features or mobile-app subscription
        tiers later. Additional terms (including refund policies) will be published at that time.
      </Typography>
...
export const CopyrightNotice = () => (
  <PageLayout>
    <div className="px-md py-lg space-y-md">
      ...
      <Typography variant="body1">© {CURRENT_YEAR} Encorelando. All rights reserved.</Typography>

      {/* 1. Ownership */}
      <Typography variant="h2">1. Ownership of content</Typography>
      <Typography variant="body1">
        Encorelando’s software, branding, and original data compilations are protected by U.S. and
      ...
      <Typography variant="body1">
        ...
        use requires prior written permission from Encorelando.
      </Typography>

      {/* 3. DMCA */}
      <Typography variant="h2">3. DMCA takedown requests</Typography>
      <Typography variant="body1">
        If you believe material on Encorelando infringes your copyright, please send a notice that
        complies with 17&nbsp;U.S.C.&nbsp;§512(c)(3) to
