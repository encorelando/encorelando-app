...
const Button = ({
  ...
  const baseClasses =
    'inline-flex items-center justify-center font-poppins font-medium rounded focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 transition-all min-h-touch';
